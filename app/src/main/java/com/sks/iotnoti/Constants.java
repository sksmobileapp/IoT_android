...
public class Constants {
    ...
    static final String CLIENT_ID = "a6b9ff12-de67-4dc8-95db-fc5085bc0b2f";

    // RedirectUri
    static final String REDIRECT_URL = "http://www.sks.com.tw";

    // URI for the resource. You need to setup this resource at AAD
    static final String RESOURCE_ID = "c53bb074-f041-4127-9120-9c7d7f4f1a33";
...
//
    public static final String LOGIN_HINT = "sks01@skiottest.onmicrosoft.com";
}
