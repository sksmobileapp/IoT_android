...
public class MainActivity extends AppCompatActivity {
    ...
    private String SENDER_ID = "1098275785136"; // Project ID
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditText.setText(Constants.LOGIN_HINT);
        ...
        new AsyncTask() {
            ...
            protected Object doInBackground(Object... params) {
                try {
                    ...
                    Log.i("Noti Register Succ", "RegId : " +
                            hub.register(regid, "username:aa").getRegistrationId());
                } catch (Exception e) {
                    Log.e("Noti Exception", e.getMessage());
                    return e;
                }
                return null;
            }
        ...
        return new AuthenticationCallback<AuthenticationResult>() {
            ...
            public void onError(Exception exc) {
                ...
                Toast.makeText(getApplicationContext(), TAG + "getToken Error:" + exc.getMessage(),
                        Toast.LENGTH_SHORT).show();
                Log.e("AuthenticationResult", TAG + "getToken Error:" + exc.getMessage());
            }
    ...
    class RequestTask extends AsyncTask<Void, String, String> {
        ...
        protected String doInBackground(Void... empty) {
            ...
            try {
                ...
                getRequest.addHeader(Constants.HEADER_AUTHORIZATION, Constants.HEADER_AUTHORIZATION_VALUE_PREFIX + mToken);
